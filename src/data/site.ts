...
export const brand = { name: "ASHANA PORT", subtitle: "СТОЛОВАЯ • КОРПОРАТИВНОЕ ПИТАНИЕ • КЕЙТЕРИНГ" };
...
export const socials = [
  ...
  { label: "WhatsApp", href: `https://wa.me/${whatsapp}?text=${encodeURIComponent("Здравствуйте! Интересует столовая, корпоративное питание или кейтеринг ASHANA PORT.")}` },
];
export const trustedCompanies = [{ name: "Sulpak" }, { name: "adidas" }, { name: "АРЗ 405", icon: "helicopter" }];
export const stats = { dailyPortions: "Более 500 порций в день", caption: "Столовая, корпоративное питание и кейтеринг" };
...
export const formats = [
  { title:"Столовая ASHANA PORT", description:"Ежедневные горячие блюда, салаты, выпечка и напитки", image:unsplash("photo-1547592180-85f173990554") },
  { title:"Корпоративное питание", description:mealLine, price:"2 500 ₸ / человек", image:unsplash("photo-1606787366850-de6330128bfc") },
  { title:"Питание сотрудников", description:"Регулярные обеды для команд с удобной доставкой", price:"2 500 ₸ / человек", image:unsplash("photo-1504674900247-0877df9cc836") },
  ...
  { title:"Банкеты и торжества", description:"Кейтеринг и праздничное меню для особых событий", image:unsplash("photo-1519167758481-83f550bb49b3") },
  { title:"Доставка готовых блюд", description:"Блюда нашей кухни в офис, на площадку или домой", image:unsplash("photo-1606787366850-de6330128bfc") },
];
export const dishes = [
...
export const gallery = [
  ["photo-1555244162-803834f70033","Столовая и кейтеринг ASHANA PORT"], ["photo-1547592180-85f173990554","Корпоративные обеды ASHANA PORT"],
...
export const eventTypes = ["Столовая / посещение","Корпоративное питание","Питание сотрудников","Кейтеринг","Фуршет","Кофе-брейк","Банкет","Частное мероприятие","Другое"];
